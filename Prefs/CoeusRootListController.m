...
- (void)viewDidLoad {
	...
	self.headerImageView.image = [UIImage imageWithContentsOfFile:@"/Library/PreferenceBundles/CoeusPrefs.bundle/banner.png"];
...
- (void)respring {
	...
	[UIView animateWithDuration:1.0 delay:0.0 options:UIViewAnimationOptionCurveEaseOut animations:^{
		...
		[HBRespringController respringAndReturnTo:[NSURL URLWithString:@"prefs:root=Coeus"]];
	}];
}
