#include "../Tweak/PlatoUIModule.h"
#include "PLTRootListController.h"

BOOL isEnabled = YES;

@implementation PLTRootListController

- (instancetype)init {
    self = [super init];

    if (self) {
        PLTAppearanceSettings *appearanceSettings = [[PLTAppearanceSettings alloc] init];
        ...
        self.iconView.image = [UIImage imageWithContentsOfFile:@"/Library/PreferenceBundles/PLTPrefs.bundle/icon@2x.png"];
...
- (void)viewDidLoad {
    ...
    self.headerImageView.image = [UIImage imageWithContentsOfFile:@"/Library/PreferenceBundles/PLTPrefs.bundle/banner.png"];
...
- (void)toggleState {
    ...
    NSString* path = [NSString stringWithFormat:@"/var/mobile/Library/Preferences/com.azzou.platoprefs.plist"];
    NSMutableDictionary* dictionary = [NSMutableDictionary dictionaryWithContentsOfFile:path];
    NSSet* allKeys = [NSSet setWithArray:[dictionary allKeys]];
    HBPreferences *prefs = [[HBPreferences alloc] initWithIdentifier: @"com.azzou.platoprefs"];
...
- (void)setEnableSwitchState {
    ...
    NSMutableDictionary* dictionary = [NSMutableDictionary dictionaryWithContentsOfFile:path];
    NSSet* allKeys = [NSSet setWithArray:[dictionary allKeys]];
    HBPreferences* prefs = [[HBPreferences alloc] initWithIdentifier: @"com.azzou.platolsprefs"];
...
- (void)resetPrompt {
    ...
    UIAlertController* resetAlert = [UIAlertController alertControllerWithTitle:@"Plato"
...
- (void)resetPreferences {
    ...
    HBPreferences* preferences = [[HBPreferences alloc] initWithIdentifier: @"com.azzou.platoprefs"];
...
- (void)respringUtil {
    ...
    [HBRespringController respringAndReturnTo:[NSURL URLWithString:@"prefs:root=Plato"]];
}
